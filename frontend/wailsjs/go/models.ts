...
export namespace core {
	...
	export class ArtifactItem {
	    ...
	    static createFrom(source: any = {}) {
	        return new ArtifactItem(source);
	    }
	...
	export class ArtifactReviewSubmission {
	    artifactName: string;
	    approved: boolean;
	    ...
	    static createFrom(source: any = {}) {
	        return new ArtifactReviewSubmission(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.comments = this.convertValues(source["comments"], LineComment);
	    }
	...
	export class CodeSearchMatch {
	    ...
	    static createFrom(source: any = {}) {
	        return new CodeSearchMatch(source);
	    }
	...
	export class CodeSearchFile {
	    path: string;
	    matches: CodeSearchMatch[];
	
	    static createFrom(source: any = {}) {
	        return new CodeSearchFile(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.path = source["path"];
	        this.matches = this.convertValues(source["matches"], CodeSearchMatch);
	    }
	...
	export class CodeSearchResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new CodeSearchResult(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.query = source["query"];
	        this.pathFilter = source["pathFilter"];
	        this.totalCount = source["totalCount"];
	        this.files = this.convertValues(source["files"], CodeSearchFile);
	    }
	...
	export class WorkspaceDiffResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new WorkspaceDiffResult(source);
	    }
